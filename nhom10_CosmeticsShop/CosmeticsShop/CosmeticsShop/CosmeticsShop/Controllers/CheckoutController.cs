        ...
        public ActionResult CreateOrder(Order order, string FullName, string PhoneNumber, string Address, string City, string District, string Ward)
        {
            ...
            try
            {
                ...
                if (isSuccess)
                {
                    ...
                    CosmeticsShop.Ultils.Ultils.SendEmail("CosmeticsShop", "Đơn hàng #" + currentOrder.Id.ToString(), customerContent.ToString(), user.Email);
                    ...
                    CosmeticsShop.Ultils.Ultils.SendEmail("CosmeticsShop", "Đơn hàng #" + currentOrder.Id.ToString(), adminContent.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
